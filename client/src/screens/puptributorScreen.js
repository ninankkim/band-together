...
export default function puptributorScreen() {
    return (
        <div>
            ...
            <img src="images/sauce.png" className="responsive" padding-top="0px"></img>
            <img src="images/hubers.png" className="responsive" padding-top="0px"></img>
            <img src="images/emmy.png" className="responsive" padding-top="0px"></img>
        </div>
    )
}
